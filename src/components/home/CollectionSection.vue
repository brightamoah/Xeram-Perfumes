...
<template>
  <section class="collection-section w-full overflow-hidden py-24 bg-obsidian">
    ...
    <div class="reveal-on-scroll text-center mb-16 px-6">
      <p class="text-[10px] tracking-[0.5em] uppercase text-gold font-light mb-4">
        Curated For You
      </p>
    ...
    <div class="reveal-on-scroll collection-ribbon-wrap relative">
      ...
      <div
        class="collection-ribbon flex gap-6 overflow-x-auto px-16 pb-4 scroll-smooth"
      ...
      >
        ...
        >
          ...
          <div class="p-6 text-center border-t border-gold/20">
            <p class="text-[9px] tracking-[0.4em] uppercase text-gold font-light mb-3">
              Collection
            </p>
            ...
            <p class="text-xs text-ash font-light leading-loose">
...
.collection-ribbon::-webkit-scrollbar {
  display: none;
}
